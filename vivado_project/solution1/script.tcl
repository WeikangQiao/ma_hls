...
export_design -format ip_catalog -description "SqueezeNet CNN implemented on FPGA" -vendor "SCS" -library "SqueezeNetFPGA" -version "0.0.1" -display_name "SqueezeNetFPGA"
