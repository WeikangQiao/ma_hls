...
network_t *get_network_config() {
  network_t *net = new network_t(26, 1405768);

  //                                                                            UPD
  // Layer Attributes: ( NAME   , TYPE      ,   W,   H,   CI,  CO, K, P, S) EXP MEM POOL Type
  addLayer(net, layer_t("conv1 ", LAYER_CONV, 256, 256,    3,  64, 3, 1, 2), 0,  1, POOL_3x3S2);
  addLayer(net, layer_t("f2/s1 ", LAYER_CONV,  64,  64,   64,  16, 1, 0, 1), 0,  1, POOL_NONE);
  ...
  addLayer(net, layer_t("f3/e3 ", LAYER_CONV,  64,  64,   16,  64, 3, 1, 1), 1,  0, POOL_3x3S2);
  addLayer(net, layer_t("f3/e1 ", LAYER_CONV,  64,  64,   16,  64, 1, 0, 1), 1,  1, POOL_3x3S2);
  addLayer(net, layer_t("f4/s1 ", LAYER_CONV,  32,  32,  128,  32, 1, 0, 1), 0,  1, POOL_NONE);
  ...
  addLayer(net, layer_t("f5/e3 ", LAYER_CONV,  32,  32,   32, 128, 3, 1, 1), 1,  0, POOL_3x3S2);
  addLayer(net, layer_t("f5/e1 ", LAYER_CONV,  32,  32,   32, 128, 1, 0, 1), 1,  1, POOL_3x3S2);
  addLayer(net, layer_t("f6/s1 ", LAYER_CONV,  16,  16,  256,  64, 1, 0, 1), 0,  1, POOL_NONE);
  ...
  addLayer(net, layer_t("conv10", LAYER_CONV,  16,  16,  512,1000, 1, 0, 1), 0,  1, POOL_GLOBAL);
